...
function parse_alert(MybbStuff_MyAlerts_Entity_Alert $alertToParse)
{
    ...
    $formatter = $GLOBALS['mybbstuff_myalerts_alert_formatter_manager']->getFormatterForAlertType($alertToParse->getType()->getCode());
