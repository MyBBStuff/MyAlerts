...
$l['setting_myalerts_cleanup_time'] = "Length of time between pruning?";
$l['setting_myalerts_cleanup_time_desc'] = "How often should the pruning task be ran? Measured in seconds and defaults to a week (604800). Set to 0 to disable the pruning task.";
